...
def test(testID):
    ...
    if save_plot: 
        ...
        tikz_save(model_path+t+'instrument_train.tex', encoding='utf-8', show_info=False)
...
with open(model_path + 'params.txt', "w", encoding='utf-8') as text_file:
    ...
    text_file.write("classes: %s" % classes + '\n')
